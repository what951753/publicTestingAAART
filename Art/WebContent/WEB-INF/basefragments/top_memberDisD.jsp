...
<body>
	<nav class="navbar navbar-expand-lg navbar navbar-dark "
		...
		<a class="navbar-brand" href="<c:url value='/userLeaveMemberArea' />"><svg
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="<c:url value='#' />">課程購買紀錄 </a></li>
				<li class="nav-item"><a class="nav-link"
					href="<c:url value='#' />">贊助紀錄</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<c:url value='#' />">場地租借紀錄</a></li>

			</ul>
			<div>
				<ul class="navbar-nav mr-auto">
					<li class="nav-item"><a class="nav-link"
						href="<c:url value='/userEnterMemberArea'/>"><img style='display:block; width:64px;height:36px;' src="data:image/jpg;base64, ${sessionScope.memberPic}" >${sessionScope.member.getName()}</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<c:url value='/userLeaveMemberArea'/>">離開會員專區</a></li>
					<li class="nav-item"><a class="nav-link"
