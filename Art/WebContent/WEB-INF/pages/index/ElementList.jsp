    ...
    pageEncoding="UTF-8"%>
		...
		<body>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="elements.html"> スタート</a></p>
						</div>											
					</div>
				</div>
			</section>
			...
			<section class="sample-text-area">
				<div class="container">
					<h3 class="text-heading">這裡列出了所有可以用的元素</h3>
					<p class="sample-text">
