...
//		helper.addAttachment("Invoice.jpg", file);
	...
	public  void processmailsendHTML(Shoppingcart shoppingcart) throws MessagingException {
		...
		String text = 
				...
				"                   <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\"> \r\n" + 
				"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
				"                      <td align=\"center\" style=\"padding:0;Margin:0;padding-bottom:5px;padding-top:10px\"><h2 style=\"Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:Poppins, sans-serif;font-size:25px;font-style:normal;font-weight:bold;color:#00413F\">親愛的"+shoppingcart.getNAME()+"先生／小姐，您好!<br>感謝您於得藝的一天購物</h2></td> \r\n" + 
				"                     </tr> \r\n" + 
				"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
				"                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:10px;padding-bottom:10px\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333\">訂單編號："+shoppingcart.getORDERID()+"<br>訂購人姓名："+shoppingcart.getNAME()+"<br>電子郵件："+shoppingcart.getEMAIL()+"<br>電話："+shoppingcart.getTEL()+"<br>地址："+shoppingcart.getADDRESS()+"<br>節目名稱："+shoppingcart.getTITLE()+"<br>票種："+shoppingcart.getTICKETCATEGORY()+"<br>數量："+shoppingcart.getTICKET_NUM()+"<br>座位編號："+shoppingcart.getSeatstring()+"<br>總金額："+shoppingcart.getTOTALPRICE()+"</p></td> \r\n" + 
				"                     </tr> \r\n" +
				"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
