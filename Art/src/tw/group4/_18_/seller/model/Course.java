...
//	private double total; // 小計
	...
	public Course(String coId, String coTitle, String coAct_Type, String coAct_Location, String coLocation_Name,
			int coNum, int coPrice, String coAct_Date, String coAct_Time, String coEnd_Date, String coEnd_Time,
			String coAct_Description, int coHot, byte[] coAct_Image, String coAct_ImageStr) {
		super();
		this.coId = coId;
...
//	return coNum * course.getCoPrice();
//}
