...
public class GlobalService {
	...
	public static final String SYSTEM_NAME = "得藝的一天";
	...
	public static String getSHA256Endocing(String message) {
		final StringBuffer buffer = new StringBuffer();
		try {
	...
	public static String getSHA384Endocing(String message) {
		final StringBuffer buffer = new StringBuffer();
		try {
	...
	public static String getSHA512Endocing(File file) throws NoSuchAlgorithmException, IOException {
...
//			int value = (b & 0x7F) + (b < 0 ? 128 : 0);
	...
	public static void main(String[] args) throws Exception {
		File file = new File("C:\\Shared\\apache-tomcat-10.0.0-M8-windows-x64.zip");
		//
		String t1 = getSHA512Endocing(file);
		System.out.println("SHA512:" + t1);
	}
